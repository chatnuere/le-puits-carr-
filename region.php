...
set_query_var('intro_section_image', get_field('region_background'));
set_query_var('intro_section_class', 'top_section--room');
set_query_var('template_main_title', get_field('region_intro_title'));
set_query_var('template_main_desc', get_field('region_intro_description'));
set_query_var('color', get_field('region_color'));
            ...
            <div class="col col-1-3__xl col-1-2__m col-1-1__s selection--item scrollMagic__smoothSlideUp">
              ...
              <a href="<?php echo $link ?>" class="selection--item--wrapper <?php echo $css_class ?>" <?php echo $target; ?>>
                <div class="selection--item--component component--icon">
                  ...
                  <? elseif (get_field('selection_icon_type') == 'other'): ?>
                    <i class="fa <?php the_field('selection_font_awesome_icon'); ?> "></i>
                    <? else: ?>
                    <div class="imageIcon" style="background-image: url('<?php the_field('selection_image') ?>')"></div>
